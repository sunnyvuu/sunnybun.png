...
export default function NavBar() {
  ...
  return (
    <nav
      className="
      flex justify-between px-4 py-3 md:items-center"
    >
      <div>
      ...
      <div
        className={
          ...
          (clicked ? " flex-col" : " hidden")
        }
      >
        <ul className="text-base text-gray-800 pt-4 md:flex md:justify-center md:pt-0 md:bg-rose-100 md:w-full">
